...
In der freien Luft werden diese Kohlenstoffpartikel zu CO_{2}. \comment{SIMR: Durch Frischluft werden diese Kohlenstoffpartikel zu CO_{2}. Was dir halt besser gefällt}
...
Der benutzte Kraftstoff bestimmt, wie viel CO_{2} bei der Verbrennung erzeugt wird. \comment{SIMR: statt erzeugt wird - als Nebenprodukt entsteht?}
Beispielsweise entsteht bei der Verbrennung von einem Liter Diesel mehr Kohlenstoffdioxid, als bei einem Liter Benzin.
Der Kraftstoffverbrauch eines Wagens und sein CO_{2}-Output stehen daher in enger Verbindung. \comment{SIMR: Kraftfahrzeug statt Wagen? Wagen könnte als Pferdekutsche missverstanden werden.}
...
Aussterben von Pflanzen und Tieren und Wetterphänomene wie zum Beispiel sehr warme Winter, Stürme etc. \comment{SIMR: Den Satz würd ich zweiteilen. Einmal Natur Folgen (steigender Meeressspiegel,...) und dann Fauna Folgen (warme Winter,...)}
