...
\subsection{Python-Frameworks(APP)}
\newline
\begin{table}[!htb]
\centering
\caption{Vergleich der Charting-Frameworks}
...
Plotly hat eins der Besten Documentationen die ich bis jetzt gesehen habe. Sie haben eine sehr große Auswahl an Charts, welche mit Code zur verfügung stehen. Weiters haben sie tutorials, Dokumentation in Chapter etc. Weiterhin ist das Framework sehr viel entwickelt worden.                  Eins der Nachteile wäre, dass wir keine SVG Images exportieren können.       Für einen Betrag von 20euro Monatlich ist auch das möglich. 
Ich bin zum Entschluss gekommen, dass Plotly das Beste Framework für unsere Webapplikation sein könnte, da sehr viel Dokumentiert , Gecodet wurde, außerdem ist es das am leichtesten erlernbare Tool.
